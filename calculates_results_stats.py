...
def calculates_results_stats(results_dic):
    ...
    #initiate a new dictionary results_statis_dic to include all statistics
    results_stats_dic = dict()
  
    #initiate all numerical elements 
    ...
    #reiterate through each element of results_dic and count if specified numerical conditions apply
    ...
    #calculate the statistics by using the calculated numericals above and checking if denominator is > 0 to avoid division by zero
